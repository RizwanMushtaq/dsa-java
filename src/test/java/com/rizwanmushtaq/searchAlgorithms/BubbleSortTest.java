...
public class BubbleSortTest {
  ...
  void testCustomComparableObjects() {
    BubbleSortTest.Person[] arr = {
        new BubbleSortTest.Person("Charlie", 30),
        new BubbleSortTest.Person("Alice", 25),
        new BubbleSortTest.Person("Bob", 20)
    };
    bubbleSort.sort(arr);
  ...
  private static class Person implements Comparable<BubbleSortTest.Person> {
    String name;
    int age;
    ...
    @Override
    public int compareTo(BubbleSortTest.Person other) {
